...
namespace planning
{
	namespace rbt
	{
		...
		protected:
            std::tuple<base::StateSpace::Status, std::shared_ptr<std::vector<std::shared_ptr<base::State>>>> extendGenSpine
        		(std::shared_ptr<base::State> q, std::shared_ptr<base::State> q_e);
            base::StateSpace::Status connectGenSpine(std::shared_ptr<base::Tree> tree, std::shared_ptr<base::State> q, std::shared_ptr<base::State> q_e);
